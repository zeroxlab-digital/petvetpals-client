                                ...
                                {cart.map((item, index) => (
                                    <div key={index} className='grid grid-cols-[4fr_1fr] max-sm:grid-cols-1 gap-5 max-sm:gap-8 items-center py-5 border-b last:border-none'>
                                        <div className='flex items-center gap-5'>
                                            <div className='product-img w-24 h-24 max-md:w-16 max-md:h-16  rounded-md bg-gray-200'></div>
                                            <div className='product-details'>
                                                <h4 className='font-semibold text-lg mb-1'>{item.product.name}</h4>
                                                <p className='text-gray-500 mb-2 max-md:hidden'>{item.product.product_description.slice(0, 50)}...</p>

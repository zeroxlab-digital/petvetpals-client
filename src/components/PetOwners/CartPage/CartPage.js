...
const CartPage = () => {
    ...
    return (
        <div className='grid grid-cols-[4fr_2fr] gap-7 items-start'>
            <div className="cart-items rounded-md border px-5 flex flex-col">
                {cartItems.map((item, index) => <div key={index} className='grid grid-cols-[4fr_1fr] items-center py-5 border-b last:border-none'>
                    <div className='flex items-center gap-5'>
                        <div className='product-img w-24 h-24 rounded-md bg-gray-200'></div>

...
import { CalendarClock, Clock, Download, PawPrint, Stethoscope } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <main className="flex-grow text-gray-900">
                ...
                <p className="uppercase text-xs font-semibold tracking-wider text-gray-600 mb-5 select-none">Veterinarian</p>
              ...
              <footer className="flex justify-end items-center text-gray-700 select-none">
        ...
        <table className="w-full border-collapse p-5">
          <thead>
            <tr className="text-left text-xs md:text-sm text-gray-500 border-b ">
              ...
              <th className="p-5">Veterinarian</th>

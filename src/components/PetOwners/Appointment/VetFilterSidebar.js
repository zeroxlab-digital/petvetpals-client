        ...
        <>
            <div className='filter-header xl:hidden flex items-center justify-between bg-white p-3 rounded-md'>
                ...
                {showResponsiveSort &&
                    <div className='responsive-sort bg-white border-t px-3 py-6 rounded-t-xl absolute bottom-0 left-0 w-full h-max'>
                        <div className='flex items-center justify-between mb-2'>
                            <h3 className='text-gray-700 text-lg font-semibold'>Sort by</h3>
                            <button onClick={() => setShowResponsiveSort(false)}><HiOutlineXCircle className='text-3xl text-gray-700' /></button>
                        </div>
                        <div className='py-5'>
                ...
                {showResponsiveFilter &&
                    <div className='responsive-filter bg-white border-t px-3 py-6 rounded-t-xl absolute bottom-0 left-0 w-full h-max'>
                        <div className='flex items-center justify-between mb-2'>
                            <h3 className='text-gray-700 text-lg font-semibold'>Filter by</h3>
                            <button onClick={() => setShowResponsiveFilter(false)}><HiOutlineXCircle className='text-3xl text-gray-700' /></button>
                        </div>
                        <div className='py-5'>
                            <div className="mb-6">
                            ...
                            <div className='mb-6'>
                                <h4 className="font-semibold text-gray-700 mb-3 text-base">Specialities</h4>

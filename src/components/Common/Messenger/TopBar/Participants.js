    ...
    return (
        <div className={`${clickedParticipant ? 'max-md:hidden' : ''} md:border-l-2   md:p-3 py-0 pr-0 md:h-[calc(100vh-10.2rem)] `}>
            <div className='flex items-center justify-between  mb-4'>
                <h3 className='text-gray-800 font-semibold  md:ml-1'>Available vets</h3>
                <div className='flex items-center gap-5'>
                    <button><Search className='h-5 w-5 text-gray-800' /></button>
                    <button><HiDotsVertical className='h-5 w-5 text-gray-800' /></button>

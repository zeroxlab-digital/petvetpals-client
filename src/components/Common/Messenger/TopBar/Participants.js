    ...
    return (
        <div className='bg-primary p-3 rounded-md md:h-[calc(100vh-10.2rem)]'>
            <div className='flex items-center justify-between  mb-4'>
                <h3 className='text-gray-200 font-medium  md:ml-1'>Available vets</h3>
                <div className='flex items-center gap-5'>
                    <button><Search className='h-4 w-4 text-gray-200' /></button>
                    <button><HiDotsVertical className='h-4 w-4 text-gray-200' /></button>
                </div>
            </div>

                ...
                {filtered_appointments.map((appointment, index) => (
                    <div key={index} className='grid grid-cols-12 items-center gap-5 border rounded-md p-5 mb-3 last:mb-0'>
                        ...
                        <div className='col-span-2'>
                            {/* <p className='text-gray-600 flex items-center gap-2 mb-2'>{appointment.pet_details?.type == 'Dog' ? <LuDog className='text-lg' /> : appointment.pet_details?.type == 'Cat' ? <LuCat className='text-lg' /> : appointment.pet_details?.type == 'Rabbit' ? <LuRat className='text-lg' /> : ''} {appointment.pet_details?.name}<span className='text-sm'>(2y/o)</span></p> */}

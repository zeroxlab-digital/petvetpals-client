        ...
        <section className="">
            <div className="app-container lg:mx-60 all-service-cont pt-36 pb-8 max-lg:text-center max-lg:space-y-5">
                <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-20 max-lg:gap-10 justify-between items-start item ">
                    <div>
                        <h2 className="text-primary text-3xl font-bold mb-16">Comprehensive Pet Care at Your Fingertips</h2>
                ...
                <div className="grid grid-cols-2  max-lg:grid-cols-1 gap-20 max-lg:gap-10 justify-between items-center lg:item">

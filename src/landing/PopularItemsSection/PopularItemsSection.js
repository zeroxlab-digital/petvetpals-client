...
const PopularItemsSection = () => {
    ...
    return (
        <section className="pb-16 md:pb-32">
            <div className="app-container mx-auto flex items-center justify-between mb-8 md:mb-12">
                <div>
                    <h3 className='text-lg md:text-xl font-semibold text-primary'>Most Popular Items</h3>
                </div>
